...
model = nn.Linear(128, 256).to(get_torch_device("cuda"))

# fuses linear + cross entropy layers together and performs chunk-by-chunk computation to reduce memory
loss_fn = LigerFusedLinearCrossEntropyLoss()

input = torch.randn(4, 128, requires_grad=True, device=get_torch_device("cuda"))
target = torch.randint(256, (4, ), device=get_torch_device("cuda"))
